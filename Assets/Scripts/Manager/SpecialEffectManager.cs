...
/// <summary>
/// SpecialEffectManager is used for managing the highlight and sound effect on objects. <br/>
/// Need HighlightEffect Compoment on the objects.
/// </summary>
public class SpecialEffectManager : MonoBehaviour
{
    ...
    private void Start()
    {
        AudioMgr = GameManager.Instance.getAudioManager();
        mAudioClips = GameManager.Instance.getAudioClips();
    }
